...
See the [current design contract](docs/superpowers/specs/2026-09-09-editorial-art-direction-design.md), [cover provenance](docs/EDITORIAL_COVERS_2026-09-09.md), [informative artwork provenance](docs/EDITORIAL_ART_PROVENANCE_2026-09-09.md), and [AdSense review](docs/ADSENSE_REVIEW_2026-09-09.md). Four articles received substantive clarity or worked-example updates in the earlier September release. Fresh release checks and exact-SHA deployment evidence are required for this revision; earlier observations do not certify it.
