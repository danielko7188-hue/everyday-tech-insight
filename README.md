...
- `.github/CODEOWNERS` and `.github/workflows/owner-only.yml`: sole-owner path attribution and the trusted-base, no-checkout pull-request author gate. Live branch protection is still a GitHub setting and must be rechecked separately.
